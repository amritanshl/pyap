pipeline {
    ...
    stages {
        stage('Build Docker Image') {
            steps {
                ...
                sh "${DOCKER_BIN} build -t my-python-webapp:latest ."
            }
        }
        ...
        stage('Clean Environment') {
            steps {
                ...
                sh "${DOCKER_BIN} rm -f python-app-container || true"
            }
        }
        ...
        stage('Deploy Application') {
            steps {
                ...
                sh "${DOCKER_BIN} run -d -p 5001:5000 -v app-db-data:/data --name python-app-container my-python-webapp:latest"
    ...
    post {
        success {
            echo " SUCCESS! App is live at http://localhost:5001"
